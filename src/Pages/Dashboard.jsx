            ...
            <div className="w-full relative pb-10 px-6 xl:px-0 bg-slate-900">
                    ...
                    <div className="w-5/6">
                        <div className="flex items-center justify-end">
                            <ul className="text-white lg:space-x-8 flex items-center leading-none">
                                <li>
                                    <a className="hover:text-indigo-500 text-lg focus:text-indigo-500" href="#">Dashboard</a>
                                </li>
                                <li className="ml-4 hover:text-indigo-500 ">
                                    <a className="focus:text-indigo-500 text-lg" href="javascript:void(0)">Alerts</a>
                                </li>
                                <li className="ml-4 hover:text-indigo-500 focus:text-indigo-500">
                                    <a className="focus:text-indigo-500 text-lg" href="javascript:void(0)">Visualizer</a>
                                </li>
                                <li className="ml-4 hover:text-indigo-500 focus:text-white">
                                    <a className="focus:text-white text-lg"  href="javascript:void(0)">Oracle</a>
                                </li>
                            </ul>
                            <div className="pl-40">
                                <button role="button" aria-label="live chat" className="focus:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 hover:bg-indigo-600 text-white px-6 py-2 font-semibold rounded focus:outline-none">Search</button>
                            </div>
                        </div>
                    </div>
                </nav>
                <div className="pt-32 lg:flex items-center relative z-10 container mx-auto">
                    ...
                    <div  role="contentinfo"  className="w-full lg:w-1/2 h-full">
                        ...
                        <h1 tabIndex="0" className="text-indigo-700 text-4xl lg:text-6xl font-black mb-8">Digi Sahayak</h1>
                        <p tabIndex="0" className="text-white font-regular mb-8">Ride the Crypto Wave with Cryptoflow: Your Ultimate Tracker for Seamless Insights and Fluid Market Flow!
                            ...
                            <div className="sm:flex items-center py-2">
                                <div className="flex items-center">
                                   <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/right_aligned_with_searchbar_Svg4.svg" alt="icon" />
                                    <input aria-label="Transaction address" className="w-28 xl:w-32 leading-none tracking-normal text-gray-800 ml-2.5 placeholder-black" placeholder="Transaction address" />
                                </div>
